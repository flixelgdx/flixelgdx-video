 ...
 * reusable {@link org.flixelgdx.graphics.FlixelImage}, and handed to core, which keeps a single
 * texture alive and scrubs its pixels. libvlc never owns a window, so videos layer like ordinary
 * state members. Install with
 * {@link org.flixelgdx.backend.desktop.video.FlixelVlcVideoHandler#install()} in your desktop
 * launcher.
 */
